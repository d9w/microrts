...
//		return "Species: " +species.size()+speciesSizes+" -- PopSize: "+nGenomes+" -- FitMax/Avg/Min: "+fitMax+"/"+fitSum/nGenomes+"/"+fitMin;
		// return fitMax+"\t"+fitMin+"\t"+species.size()+"\t"+speciesSizes+"\t"+nGenomes+"\t"+fitMax+"\t"+fitSum/nGenomes+"\t"+fitMin+"\t"+bestGRNSize+"\t"+avgGRNSize/populationSize+"\t"+maxGRNSize+"\t"+minGRNSize+"\t"+avgdist2rep;
		return fitMax+"\t"+fitSum/nGenomes+"\t"+fitMin;
	}
